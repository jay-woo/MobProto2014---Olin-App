...
//        final LatLng ac_corner_SE = new LatLng(42.293288, -71.263794);
        ...
        final View story_view = findViewById(R.id.story_button);
        ...
        story_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getFragmentManager().beginTransaction()
                        .add(R.id.main_activity, new RoomStory())
                        .commit();
            }
        });

        final ToggleButton informativeMode = (ToggleButton) findViewById(R.id.toggleButton);
